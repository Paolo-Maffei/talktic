...
static void register_block(MemDebug * b, size_t size, char *file, int line)
{
    b->next = NULL;
    b->prev = NULL;
    b->file = file;
...
static void unregister_block(MemDebug * b)
{
    if (b->file == NULL) {
...
void *js_malloc_i(JSVirtualMachine * vm, size_t size, char *file, int line)
{
    MemDebug *ptr;
...
void *js_calloc_i(JSVirtualMachine * vm, size_t num, size_t size, char *file, int line)
{
    MemDebug *ptr;
...
void *js_realloc_i(JSVirtualMachine * vm, void *ptr, size_t size, char *file, int line)
{
    void *nptr;
    MemDebug *b;
...
char *js_strdup_i(JSVirtualMachine * vm, const char *str, char *file, int line)
{
    char *tmp;
